# Program to make average rating. v1.0
...
try:
    ...
    print("Chyba: Při příštím spuštění programu zadejte, prosím, první hodnocení jako celé číslo v rozsahu 1 až 5.")
else:
    ...
    if 1 <= rating1 <= 5:
        try:
            ...
            print("Chyba: Při příštím spuštění programu zadejte, prosím, druhé hodnocení jako celé číslo v rozsahu 1 až 5.")
        else:
            ...
            if 1 <= rating2 <= 5:
                try:
                    ...
                    print("Chyba: Při příštím spuštění programu zadejte, prosím, třetí hodnocení jako celé číslo v rozsahu 1 až 5.")
                else:
                    ...
                    if 1 <= rating3 <= 5:
                        ...
                        print("Chyba: Při příštím spuštění programu zadejte, prosím, třetí hodnocení v rozsahu 1 až 5.")
            else:
                # Warn if the second input is not between 1 and 5.
                print("Chyba: Při příštím spuštění programu zadejte, prosím, druhé hodnocení v rozsahu 1 až 5.")
    else:
        # Warn if the first input is not between 1 and 5.
        print("Chyba: Při příštím spuštění programu zadejte, prosím, první hodnocení v rozsahu 1 až 5.")